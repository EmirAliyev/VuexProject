<template>
  <div class="left-wrapper">
    <transition name="animationShow"
      ><div class="usersBlock" v-if="showMode">
    ...
    <div class="showUsers" @click="changeUserShow_f">
...
export default {
  ...
  methods: {
   ...mapMutations(['changeUserShow_f','visitedUser_f']),
    visit(user) {
...
.animationShow-enter-active {
  animation: animationShow-in 0.5s;
}
.animationShow-leave-active {
  animation: animationShow-in 0.5s reverse;
}
